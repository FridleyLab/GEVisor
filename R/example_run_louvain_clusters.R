...
res = seurat_louvain(df, df_spatial, nfeatures, npcs, res)
col_pal = color_parse(col_pal, n_cats=length(unique(res[['result_df']]$cluster)))
plot_clusters(res[['result_df']], col_pal)
